...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Create_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 25, 7)
    ...
    "Create\0SetTable\0\0NewGame\0EndGame\0"
};
...
const QMetaObject Create::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Create.data,
      qt_meta_data_Create,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Create.stringdata))
