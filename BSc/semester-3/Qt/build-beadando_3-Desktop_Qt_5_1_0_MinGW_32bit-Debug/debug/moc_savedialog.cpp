...
#include "../../beaaaaaaad/savedialog.h"
...
QT_MOC_LITERAL(3, 21, 21)
    ...
    "savedialog\0saveName\0\0on_pushButton_clicked\0"
};
...
void savedialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->saveName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&savedialog::saveName)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void savedialog::saveName(QString _t1)
{
